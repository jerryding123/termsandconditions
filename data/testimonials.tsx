export default {
  ...
  items: [
    // Original testimonials with mixed format names
    {
      name: 'Ali K.',
      description: 'Tech Professional',
      children: (
        <>
          Got a new tech job after getting laid off in just 3 weeks of using this, without studying for technicals. Copilot use every week is basically unlimited.
        </>
      ),
    },
    {
